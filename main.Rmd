...
assessment$severity$si.shelt

assessment$severity %>% names
...
#   geom_line() + 
#   theme_minimal() + 
#   ylab("Fraction of sites with more the (x) percent of population with score >=3") + 
#   xlab("Score")+geom_point()
...
ggplot(diffs)+geom_bar(aes(x=value,fill=key))+hypegrammaR:::scale_fill_reach_categorical(12,name = "sub index Score")+theme_minimal()+xlab("Difference between original score and score with varied thresholds")
```
